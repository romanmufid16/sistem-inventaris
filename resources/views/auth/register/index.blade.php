    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div
            ...
            <div class="flex flex-row gap-3 pb-4">
                <h1 class="text-3xl font-bold text-[#4B5563] my-auto">Register Page</h1>
            ...
            <form class="flex flex-col" method="post" action="{{ route('register') }}">
                ...
                <button type="submit"
                    class="w-full text-[#FFFFFF] bg-[#4F46E5] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-6">Sign
                    Up</button>
                <div class="text-sm font-light text-[#6B7280] ">Already have an account? <a href="#"
                        class="font-medium text-[#4F46E5] hover:underline">Login</a>
