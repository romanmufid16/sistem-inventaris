...
<body class="bg-slate-100">
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div
            class="flex flex-col justify-center w-full md:w-1/2 xl:w-2/5 2xl:w-2/5 3xl:w-1/3 mx-auto p-8 md:p-10 2xl:p-12 3xl:p-14 bg-[#ffffff] rounded-2xl shadow-xl">
            <div class="flex flex-row gap-3 pb-4 justify-center">
                <h1 class="text-3xl font-bold text-[#4B5563] my-auto">Login Page</h1>
            ...
            <form class="flex flex-col" method="post" action="{{ route('login') }}">
                ...
                <div class="text-sm font-light text-[#6B7280] ">Don't have an accout yet? <a href="{{ route('registerPage') }}"
